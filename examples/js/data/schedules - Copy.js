...
function generateTime(schedule, renderStart, renderEnd, data) {
    ...
    var testStart = renderEnd.getTime();
...
function generateRandomSchedule1(calendar, renderStart, renderEnd, title, body) {
    var schedule = new ScheduleInfo();
...
function generateSchedule1(viewName, renderStart, renderEnd, data, testStart) {
    ...
    CalendarList.forEach(function(calendar, idx) {
        ...
        //     let retdata = generateRandomSchedule1(calendar, renderStart, renderEnd, data[i].courseName, data[i].firstName);
        ...
        for(let i=0;i<data.length;i++){
            for(let j=0;j<data[idx].length;j++){
                //javascript
                generateRandomSchedule1(calendar, renderStart, renderEnd, data[j].courseName, data[j].firstName);
            }
        }
